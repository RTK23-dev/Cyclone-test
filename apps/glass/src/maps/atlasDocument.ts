/**
 * Phone `atlas.get` document (services shape) → board document (view-model shape).
 *
 * Ported from the Cyclone One prototype (`maps/atlasClientAdapter.ts`) without the demo data source.
 */
