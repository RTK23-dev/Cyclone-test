...
function ctx(fetch) {
  ...
  return { client: new GatewayClient({ token: "t", fetch }), version: "1.0.0-alpha.18", devices, device: devices[0], devicesError: null, navigate() {}, selectDevice() {}, refreshDevices: async () => {} };
}
