...
### Phase 1: Hands (alpha.39, the release that makes typing just work)
...
| **alpha.39** | Hands: Phase 0 + Phase 1, with the Lab Hands suite as the gate. |
| **alpha.40** | Desk (Phase 2). |
